...
// 자바 패키지 임포트
// : 자바 내의 패키지에 있는 Scanner를 사용하기 위한 경로 지정
...
//		1. 출력
//		System.out.println(출력하고자하는 변수 or 상수 or 데이터값);
//		syso 단축키로 자동 완성 가능
		int number = 123;
...
//      sc.next(); // 입력 내용을 문자열로 반환
		...
		System.out.println("Enter integer: " + sc_number);
		double sc_double = sc.nextDouble();
		System.out.println("Enter Double: " + sc_double);

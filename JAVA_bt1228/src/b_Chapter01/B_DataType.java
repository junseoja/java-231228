...
// : 기본 타입, 참조 타입
//		:자바에서 미리 정의된, 
//		 기본적인 타입, 변수를 선언하면 자료형의 크기 만큼 메모리 할당
...
//		     int(기본) : 4바이트 정수 - 값의 범위(약-2.1억 ~ 2.1억)
//		     long     : 8바이트 정수 - 값의 범위(약-2^63 ~ 2^63)
		int age;
		age = 27;
		System.out.println(age);

//		long 데이터 타입은 숫자 뒤에 알파벳 L 또는 1을 써서 long형임을 표시
		long aprtmentPrice = 1000000000L;
		System.out.println(aprtmentPrice);
//      2. 문자형
...
//      3. 실수형 : 소수점 자리가 있는 수
//           float       : 4바이트 소수점, 실수값에 사용 
//                         숫자 뒤에 알파벳 F를 써서 float형임을 표시
//           double(기본) : 8바이트 소수점, 기본 실수 타입
		float height = 169.2F;
		double price = 19.3;

//	    4.논리형 : 데이터 값으로 데이터 값으로 true(참), false(거짓)만 담을 수 있음
//		: 1바이트
//		: 소문자 값 사용을 권장

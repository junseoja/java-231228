...
// 상속해주는 클래스(Parent): 조상 클래스, 부모 클래스, 상위 클래스, 기반클래스, 슈퍼클래스
// 상속 받는 클래스(Child):  자손 클래스, 자식클래스, 하위클래스, 파생클래스, 서브클래스
...
class SmartTv extends Tv {
	...
	void displayOtt (String platform) {
		if(ott) { // OTT의 상태가 on(true)일 떄만 platform을 보여줌
...
public class Inheritance01 {
	...
	public static void main(String[] args) {
		// 자식 클래스의 인스턴스르 생성하면 부모 클래스의 멤버도 함께 생성
		// >> 따로 부모 클랠스의 인스턴스를 생성하지 않고도

...
//		System.out.println(array[3]); - Error
		...
		// : new 연산자를 사용한 배열 생상 시 길이 지정 X
		// : 요소의 개수를 파악하여 배열의 길이로 자동 지정
		
		// a. 데이터 타입[] 배열명 = new 데이터타입[] {요소1, 요소2, 요소3 ...};
		...
		// 배열명.length
		System.out.println("배열의 크기(길이) = " + myArray.length); // 배열이 12개이고 인덱스는 11
		...
		fruits[0] = "apple"; 	// 문자열(''), 숫자형(0), 논리형(false)  
		fruits[1] = "banana";
		fruits[2] = "cherry";
		System.out.println(fruits[0]);
		...
		// 배열의 첫 번째 요소부터 마지막 요소까지의 수 만큼 반복
...
//		char[] Eeq = new char[3];
//		Eeq[0] =  'a'; 	 문자열(''), 숫자형(0), 논리형(false)
//		Eeq[1] =  '3';
//		Eeq[2] =  '2';
//		System.out.println(Eeq[0]);

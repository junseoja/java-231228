...
public class D_Array04 {
	...
	public static void main(String[] args) {
		...
		// 2차원 배열 선언: 데이터타입[][] 배열명;
		int[][] matrix;
		// 2차원 배열 초기화: 배열명 = new int[행의 수][행의 수];

		// 다차원 배열의 경우 각 행에서 열의 개수가 서로 달라도 가능
		// 배열을 선언할 때 열의 크기는 지정하지 않아도 가능
		// , 행의 크기는 반드시 지정
		// 배열명 = new int[반드시][선택];
		matrix = new int[3][3]; // matrix = new int[3][]; <- 상관 없음
...
//		matrix 배열과 array의 구조가 같다
		...
		System.out.println(threeFour.length); // 3
		System.out.println(threeFour[0].length); // 4

...
// 동적 배열을 사용하기 위한 ArrayLisy 구문 import
public class F_ArrayList01 {
	public static void main(String[] args) {
		...
		// ArrayList 클래스
		// : 자바의 라이브러리에서 제공하는 기능
		// : java,utills.ArrayList를 import해서 사용
		...
		// 차이점
		// : 일반 배열은 크기가 고정, ArrayList는 크기가 가변적(변할 수 있음)
		// : 배열의 타입 지정 시, 일반 데이터 타입이 아닌 참조 타입으로 작성
		// : int(Integer), char(Charactor), boolean(Boolean), String 등
		
		// ArrayList 생성
		// ArrayList<데이터타입> 배열명 = new ArrayLisy<>(선택사항);               선택사항 - 설정해도 되고 안 해도 됨

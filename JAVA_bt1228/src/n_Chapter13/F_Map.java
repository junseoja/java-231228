...
public class F_Map {
	public static void main(String[] args) {
		...
		// 값 추가
		students.put("Junseo", 23);
		students.put("DoKyung", 25);
		students.put("Kuee", 27);
		
		// 값 가져오기 
		System.out.println(students.get("DoKyung")); // 25
		
		// 값 제거
		students.remove("Junseo");
		System.out.println(students); // {Kuee=27, DoKyung=25}
		
		// 키를 통한 값을 검사
		System.out.println(students.containsKey("Kuee")); // true

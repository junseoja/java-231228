...
// 조건문(Condition)
// : 프로그래밍의 흐름을 제어하는 데 사용돠는 기본적인 구조 중 하나
...
//		if문
//		: 조건에 따라 실행시키고자 하는 로직(프로세스)이 다를 때 사용되는 구문
...
//		: 조건은 true / false의 결과를 반환하는 boolean 형태의 표현식
		
		int age = 20;
		
		if(age > 19) {
//			중괄호 안의 코드 블럭은 들여쓰기가 기본
//			조건이 true일 경우에만 {} 안에 작성한 코드 블럭이 실행
		System.out.println("성인입니다.");
		}
//		if문의 경우 코드 블럭에 오는 코드가 하나의 구문이면 {}생략 가능
		if (age > 19) System.err.println("성인입니다.");
		System.out.println("조건 검사 완료");
		
//		2. if-else문
//		: 조건이 true일 경우와 false일 때 실행되는 코드를 각각 지정한 구문
//		: if문의 조건이 거짓일 경우에만 실행할 코드블럭을 결정
		
		if(age > 19) {
			System.out.println("성인입니다."); 
		}   else  { // if문의 조건식이 false일 때가 else문의 조건
...
//	여러 문자열을 담는 참조형 데이터 타입 string
	...
	if (score < 0 || score > 100) {
		...
		System.out.println("0~59점대 사이입니다.");
		result = "F";
	}
...
//      - 메모리상의 어떠한 데이터 객체도 담고 있지 않음.
    ...
    System.out.println("결과는 : " + funResult);

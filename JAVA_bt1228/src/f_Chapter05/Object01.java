...
// : 클래스별 상수, 전체, 해당 클래스로 생성되는 모든 객체에 공유되어야 하는 값
...
class Car{
	...
	// 속도를 증가 시키는 메서드
	// increment: 지역 변수
	void accelaerate(int increment) {
...
//		myDog.age = 4; - Error
		...
		Student.schoolName = "A 고등학교"; // 정적 변수에 값 할당
		...
		student01.name = "장준서";
		student01.studentName = 1234;
		
		// 클래스 변수는 인스턴스 변수에 할당되어 사용할 X

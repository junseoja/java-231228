...
// : 해당 값을 입력하면 해당 값으로 작업을 수행하여 결과를 반환
...
// : 필요한 값의 개수만큼 변수를 선언하여 각 변수 간의 구분을 쉼표(,)를 사용
// : 변수들으 ㅣ데이터 타입이 같더라도 변수의 타입을 생략할 수 X
...
public class Method02 {
	...
	public static void main(String[] args) {
		...
		// 메서드 호출 방법
	    // : 메서드명(메서드 저의 시 작성한 매개변수 작성);
		ex1.print99danAll();
		
		// int add(int x, int y)를 호출하고 결과를 return에 저장
